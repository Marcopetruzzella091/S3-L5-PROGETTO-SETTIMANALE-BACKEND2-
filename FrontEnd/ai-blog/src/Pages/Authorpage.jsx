    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
          try {
            ...
            const article = await axios.get('http://localhost/S3-L5-PROGETTO-SETTIMANALE-BACKEND2-/Backend//wp-json/wp/v2/posts?author='+id);
...
console.log(article)
  ...
  {loading ? <div className='mx-auto text-center'> <Spinner  animation="grow" variant="success" /></div> : 
  ...
  <Card style={{ width: '18rem' }}>
   ...
   { article.map((e) =>    <Card className="text-center my-3">
      ...
      <Card.Body>
        ...
        <Button variant="primary" onClick={() => navigate("/article/" + e.id)}>Visualizza tutto</Button>
      </Card.Body>
   ...
   <Button className=' w-25  m-auto' variant="primary" onClick={() => navigate(-1)}>Torna indietro</Button>
   </div>
   </Container>
  )
}
